...
static inline uint32_t tobe32(uint32_t n) {
...
static inline uint64_t tobe64(uint64_t n) {
#ifndef WORDS_BIGENDIAN
...
static inline uint32_t frombe32(uint32_t n) {
#ifndef WORDS_BIGENDIAN
  n = __builtin_bswap32(n);
#endif
  return n;
...
static inline uint64_t frombe64(uint64_t n) {
#ifndef WORDS_BIGENDIAN
  n = __builtin_bswap64(n);
#endif
  return n;
